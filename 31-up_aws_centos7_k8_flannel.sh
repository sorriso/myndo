...
ansible-playbook ./ansible_scripts/createVM.yml --extra-vars "vm_env=aws_sandbox_centos" --vault-password-file ./ansible_scripts/vars/vault.aws_sandbox.pass --skip-tags=virtualbox,swarm,amzn2,calico

end_1=`date +%s`
start_2=`date +%s`

ansible-playbook ./ansible_scripts/installVM.yml --extra-vars "vm_env=aws_sandbox_centos" --vault-password-file ./ansible_scripts/vars/vault.aws_sandbox.pass --skip-tags=virtualbox,swarm,amzn2,calico

end_2=`date +%s`
start_3=`date +%s`

ansible-playbook ./ansible_scripts/installCluster.yml --extra-vars "vm_env=aws_sandbox_centos" --vault-password-file ./ansible_scripts/vars/vault.aws_sandbox.pass --skip-tags=virtualbox,swarm,amzn2,calico
